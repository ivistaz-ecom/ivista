...
const LeadsWordpressComponents = () => {
        ...
        <Row className="d-flex flex-column align-items-center" style={{ height: '300px' }}>
            ...
            <Col>
                <p className="text-white fw-bold fs-3 text-center d-none d-md-block">
                    Here are some leads performances<br />we have achieved for our clients.
                </p>
                <p className="text-white fw-bold fs-3 text-center d-block d-md-none">
                    Here are some leads performances we have achieved for our clients.
                </p>
            </Col>
        </Row>
    </Container>
...
export default LeadsWordpressComponents
