...
const ScrollAnimatIonindustries = () => {
    const nodesRef = useRef([]);
    const myNodesRef = useRef([]);

    useEffect(() => {
        const nodes1 = Array.from(document.getElementsByClassName("timeline-badge3"));
        const nodes2 = Array.from(document.getElementsByClassName("timeline-panel3"));
        const nodes3 = Array.from(document.getElementsByClassName("timeline-panel-img3"));
        ...
        function scrollCheck() {
            ...
            $(".KW_progressBar3").css("height", totalScroll + "%");
        }
...
export default ScrollAnimatIonindustries;
