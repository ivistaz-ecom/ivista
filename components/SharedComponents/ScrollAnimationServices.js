...
const ScrollAnimation = () => {
    ...
    useEffect(() => {
        const nodes1 = Array.from(document.getElementsByClassName("timeline-badge1"));
        const nodes2 = Array.from(document.getElementsByClassName("timeline-panel1"));
        const nodes3 = Array.from(document.getElementsByClassName("timeline-panel-img1"));
        ...
        function scrollCheck() {
            ...
            $(".KW_progressBar1").css("height", totalScroll + "%");
        }
    ...
    return (
        <div className="KW_progressContainer1">
            <div className="KW_progressBar1">
            </div>
        </div>
