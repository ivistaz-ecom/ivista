              ...
              <Row className='ps-3 pe-3'>
                ...
                <Col md={4} className="d-flex py-2">
                  <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column shadow">
                    <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                      <div className='card-title d-flex justify-content-between align-items-center'>
                        <p className="fs-18 mb-0 red para-text fw-bold ps-3">Focusing on Learning and Training</p>
                      </div>
                      <div className='d-flex flex-column flex-grow-1'>
                ...
                <Col md={4} className="d-flex py-2">
                  <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column shadow">
                    <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                      <div className='card-title d-flex justify-content-between align-items-center'>
                        <p className="fs-18 mb-0 red para-text fw-bold ps-3">In Constant Pursuit of Measurable Outcomes</p>
                      </div>
                      <div className='d-flex flex-column flex-grow-1'>
                        <p className="para-text text-dark fs-5 p-3 mb-0"> At iVistaz, we focus on measurable outcomes for our clients. Our meticulous approach involves crafting each step and backing our strategies with rigorous data analysis to ensure that we deliver the outcomes that propel you towards your goals. We prioritize transparency and accountability, providing detailed weekly, monthly, and quarterly reports to evaluate the effectiveness of our campaigns and guide continuous improvement. What our clients love about us is that we work on a performance-focused model for outcome-based campaigns. This means we get paid only we when deliver on results.</p>
                      </div>
                    </div>
                  </div>
                </Col>
