        ...
        <Container className="w-80 custom-container">
            ...
            <Row className='py-lg-5'>
                ...
                <Col md={4} className="d-flex py-2">
                    <Link href={'/case-studies/leading-water-purifier-brand-boosted-monthly-online-sales-from-1-5-cr-to-12-cr'} className='text-decoration-none'>
                ...
                {/* Column 02 */}
                <Col md={4} className="d-flex py-2">
                    <Link href={'/case-studies/online-sales-success-for-a-leading-kitchen-appliance-brand'} className='text-decoration-none'>
                        <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column">
                            <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                                <div className='card-title d-flex justify-content-between align-items-center'>
                                    <div>
                ...
                {/* Column 03*/}
                <Col md={4} className="d-flex py-2">
                    <Link href={'/case-studies/premier-hotel-chain-case-study-increased-direct-online-bookings-and-global-reach'} className='text-decoration-none'>
                        <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column">
                            <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                                <div className='card-title d-flex justify-content-between align-items-center'>
                                    <div>
            ...
            <Row className='py-lg-3'>
                {/* Column 04 */}
                <Col md={4} className="d-flex py-2">
                    <Link href={'/case-studies/top-hotel-chain-case-study-boosting-direct-online-bookings-and-revenue'} className='text-decoration-none'>
                        <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column">
                            <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                                <div className='card-title d-flex justify-content-between align-items-center'>
                                    <div>
                ...
                {/* Column 05 */}
                <Col md={4} className="d-flex py-2">
                    <Link href={'/case-studies/digital-marketing-case-study-increasing-website-traffic-and-online-revenue-for-a-major-hotel-chain'} className='text-decoration-none'>
                        <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column">
                            <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                                <div className='card-title d-flex justify-content-between align-items-center'>
                                    <div>
                    ...
                    <Link href={'/case-studies/digital-marketing-strategy-case-study-boosting-audio-equipment-sales-with-seo-and-amazon-marketing-2'} className='text-decoration-none'>
                        ...
                        <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column">
                            <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                                <div className='card-title d-flex justify-content-between align-items-center'>
                                    <div>
                                        <p className="fs-23 mb-0 red para-text fw-bold ps-3">53% </p>
                                    </div>
                                    <div className=''>
                                ...
                                <div className='d-flex flex-column flex-grow-1'>
                                    <div>
                                        <p className="card-text text-dark fs-4 p-3 mb-5">Boost in Website Traffic and 66% Social Media Conversions</p>
                                        <p className="card-text text-dark fs-4 px-4">Digital Marketing Triumph for Indian Audio Equipment Brand</p>
                                    </div>
                                </div>
                                <div className='py-5 pb-0'>
                                    <button type="button" className="btn btn-16 z-0 rounded-4">Read More</button>
            ...
            <Row className='py-lg-5'>
                ...
                {/* Column 07 */}
                <Col md={4} className="d-flex py-2">
                    <Link href={'/case-studies/b2b-lead-gen-case-study-delivering-outcomes-with-paid-marketing-for-a-global-retail-giants-csr-project'} className='text-decoration-none'>
                        <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column">
                            <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                                <div className='card-title d-flex justify-content-between align-items-center'>
                                    <div>
                ...
                {/* Column 09 */}
                <Col md={4} className="d-flex py-2">
                    <Link href={'case-studies/leading-jewelry-and-accessories-brand-case-study-increased-traffic-revenues-and-social-media-engagement'} className='text-decoration-none'>
                        <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column">
                            <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                                <div className='card-title d-flex justify-content-between align-items-center'>
                                    <div>
            ...
            <Row className='py-lg-3'>
                {/* Column -10*/}
                <Col md={4} className="d-flex py-2">
                    <Link href={'case-studies/top-beauty-brand-case-study-optimising-ecommerce-conversion-and-mobile-engagement'} className='text-decoration-none'>
                        <div className="card text-white bg-white mb-3 rounded-5 w-100 h-100 d-flex flex-column">
                            <div className="card-body d-flex flex-column justify-content-between flex-grow-1">
                                <div className='card-title d-flex justify-content-between align-items-center'>
                                    <div>
